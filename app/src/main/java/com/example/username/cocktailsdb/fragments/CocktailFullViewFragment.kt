            ...
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    if (cocktail?.strInstructionsES != null) {
                        binding.tvInstructions.text = cocktail.strInstructionsES
                    } else {
                    ...
                    binding.tvTranslatedByGoogle.visibility = if (binding.tvInstructions.text.isNotEmpty()) { View.VISIBLE } else { View.GONE }
